      ...
      {isPermitted ? (
        <View style={{flex: 1}}>
          <CameraKitCameraScreen
            ...
            flashImages={{
              // Flash button images
              on: require('./assets/images/accountIcon.png'),
              off: require('./assets/images/accountIcon.png'),
              auto: require('./assets/images/accountIcon.png'),
            }}
            cameraFlipImage={require('./assets/images/accountIcon.png')}
            captureButtonImage={require('./assets/images/story/galaryIcon.png')}
          />
        </View>
      ) : (
