      ...
      <View style={styles.father}>
        ...
        >
          <View style={[styles.container, { backgroundColor: "#5CDB8B" }]}>
            <Image source={{uri:'https://freepngimg.com/thumb/mario/20698-7-mario-transparent-background.png'}} style={styles.image} />
            <Text
              style={[
                styles.text,
          ...
          <View style={[styles.container, { backgroundColor: "#A3F989" }]}>
            <Image source={{uri:'https://pngimg.com/uploads/mario/mario_PNG53.png'}} style={styles.image} />
          ...
          <View style={[styles.container, { backgroundColor: "#CBF941" }]}>
            <Image source={{uri:'https://freepngimg.com/thumb/mario/20718-3-mario-clipart.png'}} style={styles.image} />
            <Text
              style={[
                styles.text,
                { fontSize: 50, textAlign: "center", paddingBottom: 5 }
          ...
          <View style={[styles.container, { backgroundColor: "#CBF941" }]}>
            <Image source={{uri:'https://pngimg.com/uploads/mario/mario_PNG53.png'}} style={styles.image} />
            <Animated.Image
             source={{uri:'https://pngimg.com/uploads/mario/mario_PNG53.png'}}
              style={[
                styles.trigger,
                {
